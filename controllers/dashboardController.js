...
export const getDashboardStats = catchAsyncError(async (req, res, next) => {
    ...
    const totalBillsByDate = Object.keys(groupedBillsByDate).reduce((acc, date) => {
    ...
    const totalMonthlyRevenue = Object.values(revenueByDate).reduce((sum, revenue) => sum + revenue, 0);
